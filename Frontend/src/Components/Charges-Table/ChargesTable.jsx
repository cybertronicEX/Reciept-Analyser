...
const ChargesTable = () => {
    ...
    useEffect(() => {
        const fetchChargesData = async () => {
            try {
                const response = await axios.get('http://localhost:5000/api/charges');
        ...
        const fetchCategories = async () => {
            try {
                const response = await axios.get('http://localhost:5000/api/categories'); // Replace with your backend endpoint
